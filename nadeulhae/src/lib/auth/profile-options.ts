...
export const INTEREST_OPTIONS: LocalizedOption[] = [
  ...
  { value: "walking", label: { ko: "산책", en: "Walking" } },
  { value: "cafe", label: { ko: "카페 탐방", en: "Cafe hopping" } },
  { value: "photography", label: { ko: "사진 촬영", en: "Photography" } },
  { value: "festival", label: { ko: "축제·행사", en: "Festivals" } },
  { value: "nature", label: { ko: "자연·공원", en: "Nature" } },

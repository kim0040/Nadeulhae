export const zh = {
  ...
  login_badge: "账户",
  login_title: "登录",
  login_subtitle: "使用邮箱和密码登录 Nadeulhae。",
  login_email: "邮箱",
  login_password: "密码",
  login_email_placeholder: "name@example.com",
  login_password_placeholder: "••••••••",
  login_cta_pending: "登录",
  login_no_account: "还没有账户？",
  login_go_signup: "注册",
  signup_title: "一起开始吧？",
  signup_subtitle: "告诉我们你的偏好，以便推荐出行行程。",
  signup_name: "姓名",
  signup_name_placeholder: "请输入姓名",
  signup_password_placeholder: "至少8个字符",
  signup_terms: "注册即表示您同意 Nadeulhae 的服务条款和隐私政策。",
  signup_cta_pending: "注册",
  ...
  dashboard_chat_loading: "正在加载聊天…",
  aq_fallback_warning: "暂时无法获取您所在地区的空气质量，因此同时显示全州默认空气质量。位置和天气仍以当前观测地区为准。",

export const en = {
  ...
  login_badge: "Account",
  login_title: "Login",
  login_subtitle: "Sign in to Nadeulhae with your email and password.",
  login_email: "Email",
  login_password: "Password",
  login_email_placeholder: "name@example.com",
  login_password_placeholder: "••••••••",
  login_cta_pending: "Log in",
  login_no_account: "Don’t have an account?",
  login_go_signup: "Sign Up",
  signup_title: "Ready to start?",
  signup_subtitle: "Tell us your preferences so we can recommend outings for you.",
  signup_name: "Name",
  ...
  signup_go_login: "Login",
   ...
   dashboard_chat_loading: "Loading chat…",
   aq_fallback_warning: "Air quality for your area is temporarily unavailable, so Jeonju default air-quality values are shown. Location and weather stay on the observed region.",

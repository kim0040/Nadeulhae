export const ja = {
  ...
  login_badge: "アカウント",
  login_title: "ログイン",
  login_subtitle: "メールアドレスとパスワードで Nadeulhae にログインしてください。",
  login_email: "メール",
  login_password: "パスワード",
  login_email_placeholder: "name@example.com",
  login_password_placeholder: "••••••••",
  login_cta_pending: "ログイン",
  login_no_account: "アカウントをお持ちではありませんか？",
  login_go_signup: "会員登録",
  signup_title: "一緒に始めてみませんか？",
  signup_subtitle: "好みを教えていただければ、お出かけをおすすめします。",
  signup_name: "名前",
  signup_name_placeholder: "名前を入力",
  signup_password_placeholder: "最低8文字以上",
  signup_terms: "登録により、Nadeulhae の利用規約およびプライバシーポリシーに同意したことになります。",
  signup_cta_pending: "会員登録",
  ...
  dashboard_chat_loading: "チャットを読み込み中…",
  aq_fallback_warning: "現在地の大気質を一時的に取得できないため、全州のデフォルト大気質を併せて表示します。位置と天気は観測地域のままです。",

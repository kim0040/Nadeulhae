export const ko = {
  ...
  dashboard_chat_loading: "채팅 불러오는 중…",
  aq_fallback_warning: "현재 지역 대기질을 일시적으로 불러올 수 없어 전주 기본 대기질을 함께 표시합니다. 위치와 날씨는 현재 지역 기준입니다.",

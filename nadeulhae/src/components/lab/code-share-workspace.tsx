...
const CODE_SHARE_COPY = {
  ko: {
    ...
    title: "코드공유 실험실",
    subtitle:
      "세션 링크를 공유하면 로그인 없이도 함께 편집할 수 있습니다. 링크 = 편집 권한입니다. 1시간 이상 활동이 없으면 세션이 자동 종료되고 기록은 유지됩니다.",
    listTitle: "내 코드공유 세션",
    ...
    shareSettings: "공유 설정",
    shareAccess: "접근 방식",
    shareAccessValue: "링크를 가진 누구나 참여·편집 가능 (로그인 불필요)",
  ...
  en: {
    ...
    subtitle:
      "Anyone with the session link can view and edit without logging in (link = edit access). Sessions auto-close after 1 hour of inactivity and remain as history.",
    ...
    shareAccess: "Access",
    shareAccessValue: "Anyone with the link can join and edit (no login required)",
  ...
  zh: {
    badge: "realtime collaboration",
    title: "代码共享实验室",
    subtitle: "分享会话链接即可无需登录进行协作（链接 = 编辑权限）。超过1小时无活动将自动结束，记录保留。",
    listTitle: "我的代码共享会话",
    ...
    shareSettings: "分享设置",
    shareAccess: "访问方式",
    shareAccessValue: "拥有链接的任何人可参与和编辑（无需登录）",
  ...
  ja: {
    badge: "realtime collaboration",
    title: "コード共有ラボ",
    subtitle: "セッションリンクを共有すればログイン不要で共同編集できます（リンク = 編集権限）。1時間以上操作がないと自動終了し、記録は保持されます。",
    ...
    shareSettings: "共有設定",
    shareAccess: "アクセス方法",
    shareAccessValue: "リンクを知っている全員が参加・編集可能（ログイン不要）",

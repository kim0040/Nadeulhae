  ...
  const texts = useMemo(() => {
    ...
    > = {
      ...
      zh: {
        ...
        heroDesc:
          "这是为나들해的故乡全州打造的数据驱动出行实验室。提供实时环境分析、天气简报、安全面板，以及每天早晨由NadeulAI整理的全州新闻，带来专属于全州的精细化本地体验。",
      ...
      ja: {
        ...
        heroDesc:
          "나들해の故郷、全州のためのデータ駆動型お出かけラボです。リアルタイム環境分析、天気ブリーフィング、安全パネル、そして毎朝NadeulAIがまとめる全州ニュースまで、全州だけの精密なローカル体験を提供します。",

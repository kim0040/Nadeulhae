    ...
    <main className="min-h-screen bg-background pt-32 pb-64 px-4 relative overflow-hidden">
      ...
      <div className="container max-w-5xl mx-auto relative z-10">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="p-8 rounded-[2.5rem] bg-[var(--card)] border border-[var(--card-border)]">
              <div className="flex items-start gap-4 mb-4">
                <Info className="text-sky-blue shrink-0" size={24} />
                <h3 className="font-black text-lg text-foreground">{t("cal_origin_title")}</h3>
              </div>
        ...
        <div className="pt-24 border-t border-sky-blue/10">
          <div className="mb-12">
            <h2 className="text-3xl sm:text-4xl font-black text-foreground mb-4">{t("cal_archive_title")}</h2>

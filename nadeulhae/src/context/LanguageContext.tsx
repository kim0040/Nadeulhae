...
const translations: Record<Language, Record<string, string | string[]>> = {
  ko: {
    ...
    about_algo_knockout_desc: "지진·기상특보가 감지되면 즉시 0점, 현재 비·눈·소나기가 오면 즉시 10점으로 고정합니다. 이 경우 다른 계산은 생략됩니다.",
  ...
  en: {
    ...
    about_algo_knockout_desc: "Earthquake or weather-warning data forces the score to 0. Current rain, snow, or showers force it to 10. All other calculations stop there.",
